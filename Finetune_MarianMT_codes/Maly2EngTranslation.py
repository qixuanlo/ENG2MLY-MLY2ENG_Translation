...
# 拆分训练集和测试集
trainX, testX, trainY, testY = train_test_split(malay_sentences, english_sentences, test_size=0.2, random_state=42)
...
# 保存模型和分词器
model.save_pretrained('Maly2EngTranslator')
tokenizer.save_pretrained('Maly2EngTranslator')
